    ...
    return(
        <Fragment>
            <Container dataAttribute="vertical-padding">
                <section id="container_apresentacao" className='flex flex-col-reverse justify-center items-center gap-8 sm:flex-row sm:justify-around sm:h-67.5 sm:gap-5 md:justify-between md:px-25'>
