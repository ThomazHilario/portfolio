...
type Html5IconProps = SVGProps<SVGSVGElement>

export const Html5Icon = ({ ...props }: Html5IconProps) => (
    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="40" width="40" xmlns="http://www.w3.org/2000/svg" {...props}>
