...
const ButtonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      sidebarItem:
        'bg-transparent text-neutral-300/90 min-w-48 hover:bg-[#494BD6]/10 justify-start border-l-3 border-transparent hover:border-violet-500 max-w-40 h-10 px-2 rounded-lg',
    },
  },
  defaultVariants: {
    variant: 'primary',
